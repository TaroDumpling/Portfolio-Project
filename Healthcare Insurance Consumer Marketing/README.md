...
- The metric measured is the average charge per person, higher charge indicate more revenue. Using this metric is to account for the uneven number of total customers when I compare customer profiles.
